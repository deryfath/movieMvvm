...
class MainAdapter (private var items:MutableList<MovieResult>, private val context: Context) : RecyclerView.Adapter<MainAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        view.let {
            ...
            (it.findViewById(R.id.tv_release_date) as TextView).text = "Release Date : "+data.release_date
            Glide.with(context).load(IMAGE_BASE_URL+data.poster_path).into(it.findViewById(R.id.iv_movie) as ImageView)
    ...
    fun addItems(list:MutableList<MovieResult>){
        items.addAll(list)
